...
The plugin exposes one seat per dispatch profile family — `agents/codex.md`, `agents/oc.md`, `agents/gemini.md`, `agents/grok.md`, `agents/cursor.md`, `agents/writer.md`, `agents/supervisor.md`, `agents/crew.md` — and three commands: `/clanker:clanker`, `/clanker:kimi-crew`, and read-only `/clanker:gemini`.
