---
name: oc
description: Relay for the Clanker: Opencode. Zero-discretion long-poll relay — starts one clanker_dispatch on the opencode Clanker, streams progress via clanker_wait, returns only the final result.
model: haiku
